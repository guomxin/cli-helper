...
if ($report.schemaVersion -ne "agentbridge.recovery-drill.v2") {
    throw "M2 acceptance requires a four-database recovery bundle, not a legacy single-database backup"
}
