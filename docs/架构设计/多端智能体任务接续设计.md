...
> 更新日期：2026-08-19
>
> 当前基线：OpenClaw 2026.7.1、AgentBridge OpenClaw 插件 0.4.49、中心
...
- OpenClaw `0.4.49` 按 MCP Token scope 向同一用户的网页、Telegram 和微信会话注册同一套可用工具：
...
详细实现与运维基线见 [Agent Workspace 网页端](../平台能力/智能体工作台.md)。
...
- 完整证据与剩余边界见 [整体系统验收报告](../验收记录/系统整体验收-2026-08-04.md)。
